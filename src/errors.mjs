...
// hoist for exports
export const newUnknownPropertyError = (prop) => new UnknownPropertyError(prop)
export const newUnexpectedTypeError = (expectedType, actualType) => new  UnexpectedTypeError(expectedType, actualType)
export const newUnexpectedValueError = (expectedValue, actualValue) => new  UnexpectedValueError(expectedValue, actualValue)
